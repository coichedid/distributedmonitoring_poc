package com.coichedid.pocjavaserviceerroneous.client;
...
public class ServiceClient {
    ...
    private Logger logger = LoggerFactory.getLogger("com.coichedid.pocjavaserviceerroneous.client.ServiceCliet");
